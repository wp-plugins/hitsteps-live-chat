<?php
/*
Plugin Name: Hitsteps Ultimate Live Chat
...
add_action('wp_footer', 'hitstepschat');
add_action('wp_head', 'hitstepschat');



function hitstepschat(){

global $_SERVER,$_COOKIE,$hitsteps_tracker,$hitsteps_chat;
...
*/
$keyword[0]='live chat';
$keyword[1]='hitsteps analytics';
$keyword[2]='website analytics';
$keyword[3]='support system';
$keyword[4]='helpdesk';
$keyword[5]='chat with visitors';
...
<!-- HITSTEPS LIVE CHAT TRACKING CODE<?php echo $htssl; ?><?php if (round($hitsteps_tracker==0)){ ?> - Header Code<?php }else{ ?> - Footer Code<?php } ?> - DO NOT CHANGE --><?php 
...
$option=get_hst_conf();
	...
	if ( $option['code']=='' && $_POST['action']!='do' && $_REQUEST['hitmagic']!='do' ) {
		...
		function hitsteps_warning() {
			...
			<div id='hitsteps-warning' class='updated fade'><p><strong>".__('hitsteps is almost ready.')."</strong> ".sprintf(__('You must <a href="%1$s">enter your hitsteps API key</a> to start tracking your stats.'), "options-general.php?page=hitsteps-live-chat/hitsteps.php")."</p></div>
...
<div id='hitsteps-saved' class='updated fade' ><p><strong>Hitsteps plugin setting have been saved.</strong> <?php if ($option['code']!=''){ ?><?php if (round($magiced)==0){ ?>We have started tracking your visitors and enabled chat widget. <?php } ?><?php if (round($magiced)==0){ ?><a href="http://www.hitsteps.com/login-code.php?code=<?php echo $option['code']; ?>">
...
<a target="_blank" href="http://www.hitsteps.com/?tag=wordpress-to-homepage">Hitsteps Live chat system</a></h2>
...
<textarea rows="6" name="wcode" cols="100" readonly><!-- HITSTEPS LIVECHAT TRACKING CODE - DO NOT CHANGE -->
<script src="http://www.hitsteps.com/track.php?code=<?php echo substr($option['code'],0,32); ?>" type="text/javascript" ></script>
<script src="http://www.hitsteps.com/onlinefloat.php?code=<?php echo substr($option['code'],0,32); ?>" type="text/javascript" ></script>
...
<!-- HITSTEPS ONLINE SUPPORT CODE v2.00 - DO NOT CHANGE --><div id="hs-live-chat-pos"><script type="text/javascript">
...
add_action('widgets_init', create_function('', 'return register_widget("hst_STATS");'));
	...
	function hitstepschat_settingsLink($actionLinks, $file) {
 		if (($file == 'hitsteps-live-chat/hitsteps.php') && function_exists('admin_url')) {
			$settingsLink = '<a href="' . admin_url('options-general.php?page=hitsteps-live-chat/hitsteps.php') . '">' . __('Settings') . '</a>';
	...
	add_filter('plugin_action_links', 'hitstepschat_settingsLink', 0, 2);
